      ...
      child: Column(children: <Widget>[
        ...
        Card(
          child: CachedNetworkImage(
            ...
            imageUrl:
                "http://img.golang.space/PicGo/2020-03-09-s22-v2-2575ed44417393b06cf00ab42f4c55e4_r.jpg",
            fit: BoxFit.cover,
            // 加载动画
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        MyText("CachedNetworkImage"),
        InkWellPictrue(
            "http://img.golang.space/PicGo/2020-03-09-s35-cachedImage1.png"),
        MyText("CachedNetworkImageProvider"),
        InkWellPictrue(
            "http://img.golang.space/PicGo/2020-03-09-s42-cachedImage2.png"),
      ],
    );
  }
}
